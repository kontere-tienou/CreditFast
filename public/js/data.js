...
const DEFAULT_DATABASE = {
  ...
  financial_profiles: [
    { id: 1, client_id: 1, monthly_income: 650000, other_income: 150000, monthly_expenses: 320000, existing_debt_payment: 60000, dependents_count: 3, disposable_income: 420000 },
    { id: 2, client_id: 2, monthly_income: 1100000, other_income: 200000, monthly_expenses: 450000, existing_debt_payment: 120000, dependents_count: 4, disposable_income: 730000 },
    { id: 3, client_id: 3, monthly_income: 420000, other_income: 50000, monthly_expenses: 280000, existing_debt_payment: 90000, dependents_count: 2, disposable_income: 100000 },
    { id: 4, client_id: 4, monthly_income: 780000, other_income: 100000, monthly_expenses: 310000, existing_debt_payment: 80000, dependents_count: 3, disposable_income: 490000 },
    { id: 5, client_id: 5, monthly_income: 400000, other_income: 50000, monthly_expenses: 180000, existing_debt_payment: 0, dependents_count: 1, disposable_income: 270000 }
  ],
  ...
  // 9. Savings History
  savings_history: [
    { id: 1, client_id: 1, account_id: 1, period_start: '2026-04-01', period_end: '2026-06-30', total_deposits: 1800000, total_withdrawals: 950000, deposit_count: 24, withdrawal_count: 8, average_balance: 1320000, closing_balance: 1450000 },
    { id: 2, client_id: 2, account_id: 2, period_start: '2026-04-01', period_end: '2026-06-30', total_deposits: 4500000, total_withdrawals: 3200000, deposit_count: 36, withdrawal_count: 14, average_balance: 2400000, closing_balance: 2800000 }
  ],
  ...
  loan_repayments: [
    { id: 1, loan_id: 1, due_date: '2026-07-05', payment_date: '2026-07-04', expected_amount: 235000, paid_amount: 235000, days_late: 0, status: 'PAID' },
    { id: 2, loan_id: 1, due_date: '2026-08-05', payment_date: '2026-08-05', expected_amount: 235000, paid_amount: 235000, days_late: 0, status: 'PAID' },
    { id: 3, loan_id: 1, due_date: '2026-09-05', payment_date: null, expected_amount: 235000, paid_amount: 0, days_late: 0, status: 'PENDING' },
    { id: 4, loan_id: 2, due_date: '2026-06-10', payment_date: '2026-06-10', expected_amount: 246400, paid_amount: 246400, days_late: 0, status: 'PAID' }
  ],
  ...
  scoring_models: [
    {
      ...
      description: 'Modèle d’évaluation complet pour clients avec historique d’épargne CIF ou crédits antérieurs.',
      status: 'ACTIVE',
    ...
    },
    {
      ...
      description: 'Modèle spécialisé pour primo-demandeurs sans antécédents financiers (Axé sur activité, zone, capacité nette et caution).',
      status: 'ACTIVE',
  ...
  scoring_rules: [
    ...
    { id: 1, scoring_model_id: 1, rule_code: 'REPAYMENT_CAPACITY', rule_name: 'Capacité nette de remboursement', factor_type: 'FINANCIAL', weight: 0.25, min_score: 0, max_score: 100, priority: 1, status: 'ACTIVE' },
    { id: 2, scoring_model_id: 1, rule_code: 'CREDIT_HISTORY', rule_name: 'Comportement crédits antérieurs', factor_type: 'BEHAVIOR', weight: 0.20, min_score: 0, max_score: 100, priority: 2, status: 'ACTIVE' },
    { id: 3, scoring_model_id: 1, rule_code: 'SAVINGS_DISCIPLINE', rule_name: 'Historique d’épargne CIF', factor_type: 'BEHAVIOR', weight: 0.15, min_score: 0, max_score: 100, priority: 3, status: 'ACTIVE' },
    { id: 4, scoring_model_id: 1, rule_code: 'ACTIVITY_STABILITY', rule_name: 'Stabilité & Ancienneté activité', factor_type: 'BUSINESS', weight: 0.15, min_score: 0, max_score: 100, priority: 4, status: 'ACTIVE' },
    { id: 5, scoring_model_id: 1, rule_code: 'GUARANTEE_COVERAGE', rule_name: 'Couverture par garantie', factor_type: 'COLLATERAL', weight: 0.10, min_score: 0, max_score: 100, priority: 5, status: 'ACTIVE' },
    { id: 6, scoring_model_id: 1, rule_code: 'OCR_DOCUMENT_INTEGRITY', rule_name: 'Rapprochement OCR & Pièces', factor_type: 'INTEGRITY', weight: 0.10, min_score: 0, max_score: 100, priority: 6, status: 'ACTIVE' },
    { id: 7, scoring_model_id: 1, rule_code: 'RESIDENTIAL_ZONE', rule_name: 'Facteur contextuel zone d’habitation', factor_type: 'CONTEXTUAL', weight: 0.05, min_score: 0, max_score: 100, priority: 7, status: 'ACTIVE' },

    // Cold Start Model Rules (Pondération adaptée sans historique d'épargne/crédit)
    { id: 8, scoring_model_id: 2, rule_code: 'REPAYMENT_CAPACITY', rule_name: 'Capacité nette de remboursement', factor_type: 'FINANCIAL', weight: 0.35, min_score: 0, max_score: 100, priority: 1, status: 'ACTIVE' },
    { id: 9, scoring_model_id: 2, rule_code: 'ACTIVITY_STABILITY', rule_name: 'Stabilité & Ancienneté activité', factor_type: 'BUSINESS', weight: 0.25, min_score: 0, max_score: 100, priority: 2, status: 'ACTIVE' },
    { id: 10, scoring_model_id: 2, rule_code: 'GUARANTEE_COVERAGE', rule_name: 'Garanties matérielles & Caution solidaire', factor_type: 'COLLATERAL', weight: 0.20, min_score: 0, max_score: 100, priority: 3, status: 'ACTIVE' },
    { id: 11, scoring_model_id: 2, rule_code: 'OCR_DOCUMENT_INTEGRITY', rule_name: 'Rapprochement OCR & Justificatifs', factor_type: 'INTEGRITY', weight: 0.10, min_score: 0, max_score: 100, priority: 4, status: 'ACTIVE' },
    { id: 12, scoring_model_id: 2, rule_code: 'RESIDENTIAL_ZONE', rule_name: 'Enracinement & Zone d’habitation', factor_type: 'CONTEXTUAL', weight: 0.10, min_score: 0, max_score: 100, priority: 5, status: 'ACTIVE' }
  ],
  ...
  credit_analyses: [
    {
      ...
      analysis_summary: 'Capacité de remboursement vérifiée. Activité textile mature (6 ans). Épargne moyenne de 1.32M FCFA et remboursements antérieurs impeccables.',
  ...
  // 21. Credit Reviews
  credit_reviews: [
    { id: 1, credit_request_id: 1, analyst_id: 1, review_status: 'CONFORME', recommendation: 'FAVORABLE', comment: 'Dossier complet, score 82/100, indice de confiance 94%. Recommandé pour approbation comité.', reviewed_at: '2026-08-12T16:00:00Z' }
  ],

  // 22. Credit Committee Decisions
  credit_committee_decisions: [
    { id: 1, credit_request_id: 4, committee_member_id: 3, decision: 'APPROVED', approved_amount: 3000000, approved_duration_months: 14, comment: 'Approuvé avec décaissement conditionné au démarrage des travaux du hangar avicole.', decided_at: '2026-08-10T11:00:00Z' }
  ],

  // 23. Credit Status History
  credit_status_history: [
    { id: 1, credit_request_id: 1, changed_by: 2, old_status: 'SUBMITTED', new_status: 'ANALYSIS', comment: 'Réception du dossier et affectation à l’analyste.', created_at: '2026-08-11T10:00:00Z' },
    { id: 2, credit_request_id: 1, changed_by: 1, old_status: 'ANALYSIS', new_status: 'CREDIT_REVIEW', comment: 'Scoring explicable généré (82/100) et pièces validées.', created_at: '2026-08-12T16:00:00Z' }
  ],

  // 24. Notifications
  notifications: [
    { id: 1, user_id: 1, title: 'Anomalie Détectée - Dossier #REQ-2026-0893', message: 'Date de facture antérieure de 18 mois détectée par le moteur OCR.', type: 'ANOMALY_ALERT', is_read: false, created_at: '2026-08-15T09:35:00Z' },
    { id: 2, user_id: 1, title: 'Dossier prêt pour comité', message: 'Le dossier REQ-2026-0892 (Amadou Sanogo) a été transmis au comité.', type: 'COMMITTEE_READY', is_read: true, created_at: '2026-08-13T10:00:00Z' }
  ],

  // 25. Audit Logs
  audit_logs: [
    { id: 1, user_id: 1, action: 'SCORING_V2_EVALUATION', entity_type: 'credit_analyses', entity_id: 1, details: 'Évaluation V2 du dossier REQ-2026-0891 (Score 82/100, Confiance 94%)', ip_address: '197.239.67.12', created_at: '2026-08-12T15:00:00Z' },
    { id: 2, user_id: 1, action: 'OCR_EXTRACT_VERIFY', entity_type: 'document_extractions', entity_id: 1, details: 'Validation de l’extraction OCR de la facture SOTIBA (confiance 96%)', ip_address: '197.239.67.12', created_at: '2026-08-12T14:30:00Z' }
  ],

  // 26. Sanctions & Watchlist (Conformité DigiCoop-WA+)
  sanctions_watchlist: [
    { id: 1, full_name: 'Ibrahim Ould Mohamed', aliases: 'Al-Sahraoui', country: 'Mali', category: 'TERRORIST_FINANCING_FP', risk_level: 'HIGH_BLOCKING', match_reason: 'Inscrit sur la liste des sanctions régionales UEMOA / ONU' },
    { id: 2, full_name: 'Ousmane Coulibaly', aliases: 'Ex-Directeur Marchés Publics', country: 'Mali', category: 'PEP_PPE', risk_level: 'ENHANCED_DILIGENCE', match_reason: 'Personne Politiquement Exposée (PPE) - Exige validation conformité renforcée' }
  ]
};
...
class DatabaseStore {
  ...
  insert(table, item) {
    ...
    const maxId = this.data[table].reduce((max, obj) => (obj.id > max ? obj.id : max), 0);
    item.id = maxId + 1;
